...
void main() {
  ...
  late MockGetTopRatedTvSeries mockList;

  setUp(() {
    mockList = MockGetTopRatedTvSeries();
    topRatedTvSeries = TopRatedTvSeriesBloc(mockList as GetTopRatedTvSeries);
  });
  ...
  test('initialState TopRated TvSeries should be empty', () {
    expect(topRatedTvSeries.state, equals(TopRatedTvSeriesEmpty()));
  });

  blocTest<TopRatedTvSeriesBloc, TopRatedTvSeriesState>(
    'should change TopRated TvSeries data when data is gotten successfully',
    build: () {
  ...
  blocTest<TopRatedTvSeriesBloc, TopRatedTvSeriesState>(
    ...
    expect: () => [
      TopRatedTvSeriesLoading(),
      const TopRatedTvSeriesError(ServerFailure('Server Failure')),
    ],
  );
}
